...
# 重新创建环境
env = gym.make('Env_topoint_OSC-v0', gui=1, mode='P', P_sens=1, P_max_force=60)
...
# 继续训练
model.learn(total_timesteps=300000, callback=callback, reset_num_timesteps=False)

# 保存模型
model.save("topoint_OSC_model_continued")
