...
DIM_OBS = 21 # no. of dimensions in observation space
...
class MagnetEnv(gym.Env):
    ...
    def __init__(self,gui=1,mode ="P",record=False,T_sens = 200, V_sens=1, P_sens = 1, P_max_force=300):
        ...
        #tip pos(3),tip ori(3),arm vel(6),arm pos(6),target tip pos(3)，obj pos(3)，obj_vel(3)
        self.observation_space = gym.spaces.box.Box(    #change later
            ...
            low = np.array([-2,-2,-2,-3.14 ,-3.14, -3.14,-5,-5,-5,-5,-5,-5,-3.14 ,-3.14, -3.14, -3.14,-3.14,-3.14,-2,-2,-2,-2,-2,-2,-3.14,-3.14,-3.14,-2,-2,-2]),
            high = np.array([2, 2, 2, 3.14, 3.14, 3.14, 5, 5, 5, 5, 5, 5,3.14, 3.14, 3.14, 3.14, 3.14, 3.14, 2, 2, 2, 2, 2, 2, 3.14, 3.14, 3.14,2,2,2])
        )
    ...
    def reset(self, seed=None, **options):
        ...
        self.agent = manipulators.Manipulator(self._p, path="my_env/Mag_Env/ur10e/ur10e.urdf", position=[0., 0., 0.4], ik_idx=6)
